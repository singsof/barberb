        ...
        <div class="row" style="padding: 20px">
            <form id="form-edit_hai" action="javascript:void(0)" method="post">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">แก้ไขข้อมูล</button> <button type="button" onclick="location.assign('./hairdresser_mg.php')" class="btn btn-warning">ยกเลิก</button>
                </div>
        ...
        $.ajax({
            ...
            success: function(result, textStatus, jqXHR) {
                ...
                if (result == "success") {
                    ...
                    location.assign('./hairdresser_mg.php')
                } else {
