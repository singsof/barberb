        ...
        <div class="form-container">
            ...
            <div class="form-inner">
                <form id="form-login" action="javascript:void(0)" method="post" class="login">
                    <div class="field">
                        <input type="tel" name="tel_user" placeholder="เบอร์โทร" required pattern="^0+[0-9]{8,9}$">
                    </div>
                    <div class="field">
                        <input type="password" name="pass_user" placeholder="รหัสผ่าน" required pattern="^(?=.*[a-z])(?=.*[0-9]).{6,64}$">
                    </div>
                ...
                <form id="form-signup" action="javascript:void(0)" method="post" class="signup">
                    <div class="field">
                        <input type="text" name="name_user" placeholder="ชื่อ" required pattern="^[a-zA-Zก-๏\s]+$">
                    </div>
                    <div class="field">
                        <input type="text" name="lastname_user" placeholder="นามสกุล" required pattern="^[a-zA-Zก-๏\s]+$">
                    </div>
                    <div class="field">
                        <input type="text" name="tel_user" placeholder="เบอร์โทร" required pattern="^0+[0-9]{8,9}$">
                    </div>
                    <div class="field">
                        <input type="email" name="e_mail" placeholder="อีเมล์" required pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
                    </div>
                    <div class="field">
                        <input type="password" name="pass_user" placeholder="รหัสผ่าน" required pattern="^(?=.*[a-z])(?=.*[0-9]).{6,64}$">
                        <p>* กรุณากรอกรหัสผ่าน a-z และ 0-9 จำนวน 6 ตัวอักษรขึ้นไป</p>
                    </div>
                    <!-- <div class="field"> -->
                        ...
                        $.ajax({
                            ...
                            success: function(result, textStatus, jqXHR) {
                                ...
                                if(result == "login-user"){
                                    ...
                                    location.assign("./hairdresser/index.php")
